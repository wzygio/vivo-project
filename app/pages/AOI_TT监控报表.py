...
PRODUCT_CACHE_INDICATORS = ("aoi_tt_sheet_oos",)
...
AOI_TT_PAGE_CACHE_SIGNATURE = "aoi_tt_report_v4_integer_particle_quantities"
...
product_revision = get_indicator_product_revision("aoi_tt_sheet_oos", current_product)
try:

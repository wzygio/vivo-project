...
### Sql语句
请参考：`docs\dev_docs\dev_spec\indicator_domain\sql-IJP溢流报表开发.md`
...
### 报表样式
1. 前端样式：开发界面（FineReport中的开发截图）参考`docs\dev_docs\dev_spec\indicator_domain\IJP溢流报表样式-开发界面.png`

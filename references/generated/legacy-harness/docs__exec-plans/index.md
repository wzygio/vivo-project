...
Use this file as the Agent-maintained entrypoint for implementation plans.

## Plan Registry

- [Plan overview](PLANS.md): legacy project plan overview and template.
- [Harness architecture refactor](plan-harness_refactor.md): current Harness routing/index/specs cleanup.

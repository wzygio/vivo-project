...
class AlertService:
    ...
    def get_dashboard_alerts(
        ...
        # 0. 获取配置的目标 Group
        # e.g., ["Array_Line", "Array_Pixel", "OLED_Mura"]
        target_defect_groups = CONFIG['processing'].get('target_defect_groups', [])
        ...
        # B. 清洗 Code 数据 (必须做！因为底层生成的是全量 Code)

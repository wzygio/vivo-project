    ...
    with engine.begin() as connection:
        ...
        connection.execute(
            text(
                ...
                f"('2026-08-31 08:00:00','G1','SPEC1','C3DM1','{_image('B0')}'),"
                f"('2026-08-31 08:05:00','G1','SPEC1','C3DM1','{_image('B0')}'),"
                f"('2026-08-31 08:10:00','G1','SPEC1','C3RA1','{_image('HT1')}'),"
                f"('2026-08-31 09:00:00','G2','SPEC2','C3DM2','{_image('LT')}'),"
                f"('2026-08-31 10:00:00','G3','SPEC1','C3DM1','{_image('T0')}'),"
                f"('2026-08-31 11:00:00','G4','SPEC1','X9XX9','{_image('T0')}'),"
                f"('2026-08-29 08:00:00','G5','SPEC1','C3DM1','{_image('R2')}'),"
                f"('2026-08-31 07:00:00','G6','SPEC1','C3DM3','{_image('L3')}'),"
                f"('2026-09-01 07:00:00','G7','SPEC1','C3DM4','{_image('RB')}')"
            )
        )
        connection.execute(
            text(
        ...
        connection.execute(
            text(
                ...
                "('G1','2026-08-31 07:30:00','3CEE01-IK2-PR1','REQ1'),"
                "('G2','2026-08-31 08:30:00','3CEE02-IK2-PR2','REQ2'),"
                "('G3','2026-08-31 09:30:00','9XXXX9-XX9-XX9','REQ1'),"
                "('G4','2026-08-31 10:30:00','3CEE01-IK2-PR1','REQ1'),"
                "('G5','2026-08-29 07:30:00','3CEE01-IK2-PR2','REQ1'),"
                "('G6','2026-08-31 07:00:00','3CEE04-IKT-PRT','REQ1'),"
                "('G7','2026-09-01 06:30:00','3CEE04-IKT-PRT','REQ1')"
            )
        )
        connection.execute(
            text(
        ...
        connection.execute(
            text(
                ...
                "('G1','LOT1','CYC1','M626','2026-08-31 12:00:00'),"
                "('G2','LOT2','CYC2','M678','2026-08-31 13:00:00'),"
